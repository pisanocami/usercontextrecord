...
export const DTC_FOOTWEAR_CAPABILITY: CapabilityModel = {
  base_score: 0.5,
  boosters: [
    { pattern: "recovery|recover|post.?workout|after.?run|post.?run", weight: 0.15, label: "Recovery focus" },
    { pattern: "plantar fasciitis", weight: 0.20, label: "Plantar fasciitis" },
    { pattern: "arch support", weight: 0.10, label: "Arch support" },
    { pattern: "after running|after workout", weight: 0.10, label: "After activity" },
    { pattern: "sandals?|slides?|flip.?flops?|clogs?|slippers?", weight: 0.08, label: "Category match" },
    { pattern: "foot pain|heel pain|bunions?|flat feet", weight: 0.12, label: "Pain/condition" },
    { pattern: "comfort|comfortable|cushion|soft", weight: 0.05, label: "Comfort focus" },
    { pattern: "nurses?|nursing|doctors?|healthcare|hospital|standing all day", weight: 0.08, label: "Professional" },
    { pattern: "orthopedic|ortho|supportive|therapeutic", weight: 0.10, label: "Medical" },
    { pattern: "shower shoes?|pool shoes?|water.?proof|beach|spa", weight: 0.05, label: "Water/spa" },
  ],
  penalties: [
